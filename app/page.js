      ...
      >
        ...
        <header className='absolute top-0 left-0 w-full z-20'>
          <div className='max-w-7xl mx-auto px-4 py-6 flex items-center justify-between'>
            <div className='text-white font-semibold tracking-[0.25em] text-xl'>
              AMAYA
              <div className='text-[10px] tracking-[0.35em] text-white/70 mt-1'>
                REAL ESTATE
              </div>
            </div>
        ...
        <div className='relative z-10 min-h-screen flex items-end justify-center pb-20 px-4'>
          <div className='max-w-4xl text-center'>
            <p className='text-white/80  tracking-widest uppercase mb-4 text-3xl'>
              Coming Soon
            </p>
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <h2 className="mt-3 text-white text-3xl md:text-5xl font-semibold leading-tight">
          Register for updates <br className="hidden md:block" /> & early access.
        </h2>

        <p className="text-white/75 mt-4 leading-relaxed max-w-xl">
          Get first updates on new project launches, site visits, offers, and
          availability. Our team will contact you shortly.
        </p>

        <div className="mt-7 flex flex-wrap gap-3">
          {['Premium Locations', 'Verified Properties', 'Exclusive Deals'].map(
            (item) => (
              <span
                key={item}
        ...
        <div className="mt-10 border-t border-white/15 pt-6 text-white/70 text-sm">
          <p>
            <span className="text-white font-semibold">AMAYA</span> — crafted for
            comfort, trust, and timeless living.
          </p>
        </div>
      </div>
